...
\begin{table}[htbp]
  ...
  \caption{Add caption}
    \begin{tabular}{rrr}
    \toprule
    \multicolumn{1}{c}{\textbf{Port}} & \multicolumn{1}{c}{\textbf{Description}} & \multicolumn{1}{c}{\textbf{Service}} \\
    \midrule
    \multicolumn{1}{l}{/dev/ttyACM0} & \multicolumn{1}{l}{modem AT command interface 0} & \multicolumn{1}{l}{Used by wvdial and ppp for a data connection over GPRS link} \\
    \multicolumn{1}{l}{/dev/ttyACM1} & \multicolumn{1}{l}{modem AT command interface 1} & \multicolumn{1}{l}{used by the SSM as a configuuration interface} \\
    \multicolumn{1}{l}{/dev/ttyACM2} & \multicolumn{1}{l}{GNSS serial NMEA output} & \multicolumn{1}{l}{used by GPS system for location information} \\
    \bottomrule
    \end{tabular}%
  \label{tab:addlabel}%
\end{table}%
