...
GPS location will be determined using the on-board GPS/GSNS block inside the Telit GE910-GNSS module. pynmea2 is used to parse Telit NMEA strings into Python objects so they can integrated as MQTT updates. See the Appendix for the parsed data format and structure.
