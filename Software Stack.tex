...
The SSM's location will be determined using the on-board GNSS block inside the Telit GE910-GNSS module. pynmea2 is used to parse \href{http://www.nmea.org/content/nmea_standards/nmea_0183_v_410.asp}{NMEA0183} formatted strings strings into Python objects so they can integrated as MQTT updates. See the Appendix for the parsed data format and structure.
